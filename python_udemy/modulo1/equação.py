...
'''
rect_cabeca_snake = rect_corpo_snake
imagen_cabeca_snake = pygame.image.load('C:/Users/k/Documents/cursos/python/projvs/imagens/cabeca_snake.png')
imagen_cabeca_snake_redimencionada = pygame.transform.scale(imagen_cabeca_snake,(tamanho,tamanho))

rect_corpo_snake = pygame.draw.rect(tela, white, [XY[0], XY[1],tamanho,tamanho])
imagen_corpo_snake = pygame.image.load('C:/Users/k/Documents/cursos/python/projvs/imagens/corpo_snake.png')
imagen_corpo_snake_redimencionada = pygame.transform.scale(imagen_corpo_snake,(tamanho,tamanho))
'''
